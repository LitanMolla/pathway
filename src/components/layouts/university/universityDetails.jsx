        ...
        <Container>
          ...
          <div className="mt-10">
            ...
            <div className="w-80 md:w-150 mx-auto">
              <img src={intiImage} alt="" className="h-full w-full" />
            </div>
            <div className="py-2 pl-10 bg-secondary/80 mt-6">
              <P18 text={"Course Name"} className={"text-white font-bold"} />
            </div>
            <div className="py-2 pl-10 bg-secondary/50 ">
              <P18 text={"Course Name"} className={"text-white"} />
            </div>
          </div>
          {/* ============================= */}
        </Container>
